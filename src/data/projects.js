export const projects = [
  ...
  {
    id: 'icss',
    title: 'Intelligent Customer Support System (ICSS)',
    summary: 'AI-driven chatbot using vector search and LLMs; Flask backend and FAISS for vector DB.',
    tech: ['Python', 'Flask', 'FAISS', 'LLMs'],
    link: 'https://github.com/Harihkvent/ICSS.git'
  },
  {
    id: 'receipt-ocr',
    title: 'Receipt OCR System',
    summary: 'End-to-end OCR to digitize receipts extracting merchant, date and totals using Tesseract & spaCy.',
    tech: ['FastAPI', 'Tesseract', 'MongoDB', 'React Native'],
